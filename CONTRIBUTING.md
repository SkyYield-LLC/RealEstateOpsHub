# Contributing to Stacks · RealEstateOpsHub
...
```bash
git clone https://github.com/SkyYield-LLC/RealEstateOpsHub.git
cd realestateopshub
npm install
...
- `main` → production (auto-deploys to https://realestateopshub.vercel.app)
...
Push to `main` → Vercel auto-deploys to https://realestateopshub.vercel.app.

## Where to ask for help

- **Linear:** [Stacks · RealEstateOpsHub](https://linear.app/skyyield/project/stacks-realestateopshub-69e0d21a835b) — file an issue or comment on existing
